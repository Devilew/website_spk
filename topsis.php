<head>
    ...
    <h3><b>Skor Ternormalisasi Terbobot</b></h3>
    <table class="table table-bordered" border="1">
    <tr style="background-color: aqua">
        <th></th>
        <th>A1</th>
    ...
    <h3><b>Solusi Ideal Positif</b></h3>
    <table class="table table-bordered" border="1">
    <tr style="background-color: aqua">
        <th></th>
        <th>C1</th>
    ...
    <h3><b>Solusi Ideal Negatif</b></h3>
    <table class="table table-bordered" border="1">
    <tr style="background-color: aqua">
        <th></th>
        <th>C1</th>
    ...
    <h3><b>Jarak Solusi Ideal Positif</b></h3>
    <table class="table table-bordered" border="1">
    <tr style="background-color: aqua">
        <th></th>
        <th>D1+</th>
    ...
    ?>
    <!-- Jarak Solusi ideal positif----------------->    
    <h3><b>Jarak Solusi Ideal Negatif</b></h3>
    <table class="table table-bordered" border="1">
    <tr style="background-color: aqua">
        <th></th>
        <th>D1-</th>
    ...
    <h3><b>Skor Akhir Setiap Alternatif</b></h3>
    <table class="table table-bordered" border="1">
    <tr style="background-color: aqua">
        <th></th>
        <th>V1</th>
    ...
    <tr>
        ...
        if ($v1 > $v2 && $v1 > $v3) {
            ...
            echo ("<h4><b>Pilihan yang terpilih adalah Alternatif 3 yaitu Sepatu 3</b></h4>");
        }
